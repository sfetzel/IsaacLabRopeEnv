...
def run_simulation_loop(
    ...
    def set_successful_instance():
        nonlocal set_successful
        set_successful = True
    ...
    teleop_interface.add_callback("P", set_successful_instance)
    teleop_interface.add_callback("O", start_recording_instance)
